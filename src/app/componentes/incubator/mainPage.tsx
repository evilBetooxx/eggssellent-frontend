        ...
        <div className="grid grid-cols-4 gap-4 text-white z-10">
          <div className="bg-black bg-opacity-10 rounded-lg p-4 h-auto">
            ...
            <p className="text-sm">
              ...
              humedad constantes en la incubadora, garantizar una adecuada
              ventilación en la incubadora puede contribuir al desarrollo para
              mantener una eclosión exitosa.
            </p>
            <img
              src="/star.png"
              alt="Pollito"
              className="mt-8 w-1/6 float-left "
            />
            <img
              src="/star.png"
              alt="Pollito"
          ...
          <div className="bg-black bg-opacity-10 rounded-lg p-4 h-auto">
            ...
            <p className="text-sm">
              ...
              temperatura y humedad, así como una ventilación adecuada. Ademas
              es importante la posicion de los huevos para evitar movimientos
              bruscos y garantizar un desarrollo adecuado.
            </p>
            <img
              src="/star.png"
              alt="Pollito"
          ...
          <div className="bg-black bg-opacity-10 rounded-lg p-4 h-auto">
            ...
            <p className="text-sm">
              ...
              ambientales. Se requiere una temperatura y humedad precisas para
              evitar problemas como la deshidratación de los huevos o el
              desarrollo anormal de los embriones.
            </p>
            <img
              src="/star.png"
              alt="Pollito"
